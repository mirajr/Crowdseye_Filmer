...
static NSString * const KFS3StreamBucketNameKey = @"crowdseye";
static NSString * const KFS3StreamAWSAccessKey = @"AKIAJDYTVYHLJGPL2UBA";
static NSString * const KFS3StreamAWSSecretKey = @"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";
...
static NSString * const KFS3StreamAWSRegionKey = @"AWSRegionUSWest1";
